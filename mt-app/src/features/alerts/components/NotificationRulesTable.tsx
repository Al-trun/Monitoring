...
export function NotificationRulesTable() {
  ...
  return (
    <div className="mt-12">
      ...
      {/* Table */}
      <div className="overflow-hidden rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/30">
              ...
              <tr key={rule.id}>
                ...
                <td className="px-6 py-4 text-center">
                  <input
                    ...
                    className="w-4 h-4 rounded text-primary focus:ring-primary dark:bg-slate-800 dark:border-slate-700"
                  />
                </td>
                <td className="px-6 py-4 text-center">
                  <input
