    ...
    <div className="p-6 rounded-xl border border-slate-200 dark:border-ui-border-dark bg-white dark:bg-bg-surface-dark">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="bg-slate-100 dark:bg-slate-800 border-none rounded-lg pl-10 pr-4 py-1.5 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 w-full sm:w-64 focus:ring-1 focus:ring-primary"
            />
          </div>
        </div>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left">
          <thead>
            <tr className="text-slate-400 dark:text-slate-500 text-xs font-bold uppercase tracking-widest border-b border-slate-200 dark:border-slate-800">
            ...
            {filteredLogs.map((log) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-4 px-2 text-slate-500 dark:text-slate-400 whitespace-nowrap tabular-nums">
      ...
      {filteredLogs.length > 0 && logs.length >= limit && (
        <div className="mt-6 flex justify-center">
          <button
            ...
            className="cursor-pointer flex items-center gap-2 px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-700 text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors disabled:opacity-50"
          >
            {isLoadingMore ? (
